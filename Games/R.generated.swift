...
struct _R {
  ...
  struct string {
    ...
    /// This `_R.string.navigationTitle` struct is generated, and contains static references to 3 localization keys.
    struct navigationTitle {
      ...
      ///
      /// Key: login
      var login: RswiftResources.StringResource { .init(key: "login", tableName: "navigationTitle", source: source, developmentValue: nil, comment: nil) }
    }
  }
